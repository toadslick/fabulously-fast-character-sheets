---
layout: layout.njk
title: Fabulously Fast Character Sheets
description: Printable character sheets, quick references, and gameplay tools for the Fabula Ultima tabletop RPG.
author: James Childress
footer: This character sheet is an independent production and is not affiliated with Need Games or Rooster Games.	Published under the Fabula Ultima Third Party Tabletop License 1.0
---
...
Years of running tabletop RPGs has taught us that games flow the smoothest when players have all the information they need right in front of them.
...
<div class="result" id="classes">

**Every official character class, fully represented on a single printed page.**

</div>

This includes all classes from the Core Rulebook, the [High Fantasy Atlas](https://www.drivethrurpg.com/en/product/445259/fabula-ultima-atlas-high-fantasy), the [Natural Fantasy Atlas](https://www.drivethrurpg.com/en/product/514616/fabula-ultima-atlas-natural-fantasy), the [Techno Fantasy Atlas](https://www.drivethrurpg.com/en/product/481039/fabula-ultima-atlas-techno-fantasy), and the [Bonus Content](https://www.drivethrurpg.com/en/product/553256/fabula-ultima-ttjrpg-bonus-collection). Gone are the days of copying the full text of a spell or class skill!

Classes from the core rulebook also come with playtest versions that include all the changes to their spells and skills from the [official playtest materials](https://www.patreon.com/posts/46567344).

<div class="result" id="npc">

**A step-by-step checklist and single-page character sheet for quickly creating NPCs.**

</div>
<div class="result" id="guide">
